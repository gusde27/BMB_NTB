                                        ...
                                        <form action="/mahasiswa" method="POST" id="formadd">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama" id="nama" placeholder="Nama Lengkap" value="<?= old('nama'); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="jurusan" id="jurusan" placeholder="Jurusan" value="<?= old('jurusan') ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="tempat_lahir" id="tempat_lahir" placeholder="Tempat Lahir" value="<?= old('tempat_lahir') ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="tanggal_lahir" id="tanggal_lahir" placeholder="Tanggal Lahir" value="<?= old('tanggal_lahir') ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea
                                                    ...
                                                    name="alamat" id="alamat" rows="3" placeholder="Alamat"><?= old('alamat') ?></textarea>
                                                    <div class="invalid-feedback">
