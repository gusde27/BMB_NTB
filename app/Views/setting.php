                    ...
                    <div class="col mr-2">
                        ...
                        <form action="/update_pass_pts" id="update_pass" method="POST">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" form="update_pass" name="old_pass"
                                    placeholder="Masukan Password Baru">
                            </div>
                            <div class="form-group">
                                <label>Password Baru</label>
                                <input type="password" class="form-control" form="update_pass" name="new_pass"
                                    placeholder="Masukan Password Baru">
                            </div>
                            <div class="form-group">
                                <label>Password Baru</label>
                                <input type="password" class="form-control" form="update_pass" name="new_pass2"
                                    placeholder="Masukan Password Baru">
                            </div>
