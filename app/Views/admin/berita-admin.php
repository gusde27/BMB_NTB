...
<ul class="nav navbar-nav flex-nowrap ml-auto">
    ...
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Berita</h3>
    </div>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- Isi Form-->
                                    <form action="/tambah_berita_admin" method="POST" id="Berita"
                                            ...
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Isi Form-->
                                                        <div class="container">
                                                            <form action="/update_berita_admin" method="POST"
                                        ...
                                        <div class="modal fade" style="color: none;" id="delete_berita<?= $a ?>"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Isi Form-->
                                                        <form action="/delete_berita_admin" method="POST"
