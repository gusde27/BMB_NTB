                    ...
                    <div class="col mr-2">
                        ...
                        <form action="/update_fotoMhs" method="POST" id="fotoMhs" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-2">
                                <input type="file" accept="image/x-png,image/jpg,image/jpeg" class="form-control-file" form="fotoMhs" name="foto_profile"
                                    id="foto_profile">
                            </div>
                            <div class="form-group mt-2">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="/upload_khs" method="POST" id="KHS" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" accept="application/pdf" class="form-control" name="file" id="file" form="KHS">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="/update_khs" method="POST"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="File">File KHS</label>
                                                                <input type="file" accept="application/pdf" form="update_khs_<?= $id['id'] ?>"
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="/upload_krs" method="POST" id="KRS" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" accept="application/pdf" class="form-control" name="file" id="file" form="KRS">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="/update_krs" method="POST"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="File">File KRS</label>
                                                                <input type="file" accept="application/pdf" form="update_krs_<?= $id['id'] ?>"
                                                                    class="form-control" name="file"
                                                                    value="<?= $id['file'] ?>">
                                                                <span>File KRS (.PDF)</span>
                                                            </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="/upload_prestasi" method="POST" id="Tambah_prestasi"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" accept="application/pdf" form="Tambah_prestasi" class="form-control" name="file">
